...
from queries import PATCHES_QUERY, PHASES_QUERY, TEAM_QUERY, general_stats_query
...
other_df = pd.DataFrame(run_query(general_stats_query(patches, phases, teams)), columns=[
